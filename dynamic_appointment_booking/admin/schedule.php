...
<body>
    ...
    <div class="container">
        <div class="menu">
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-shop ">
                ...
                <tr>
                    <td colspan="4" style="padding-top:0px;width: 100%;" >
                        ...
                        <select name="docid" id="" class="box filter-container-items" style="width:90% ;height: 37px;margin: 0;" >
                            <option value="" disabled selected hidden>Choose shop Name from the list</option><br/>
                                
                            <?php 
                            
                                $list11 = $database->query("select  * from  shop order by docname asc;");
                ...
                <?php
                    if($_POST){
                        ...
                        if(!empty($_POST["docid"])){
                            $docid=$_POST["docid"];
                            $sqlpt2=" shop.docid=$docid ";
                        }
                        //echo $sqlpt2;
                        //echo $sqlpt1;
                        $sqlmain= "select schedule.scheduleid,schedule.title,shop.docname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join shop on schedule.docid=shop.docid ";
                        ...
                        $sqlmain= "select schedule.scheduleid,schedule.title,shop.docname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join shop on schedule.docid=shop.docid  order by schedule.scheduledate desc";
    ...
    if($_GET){
        ...
        if($action=='add-session'){
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <td class="label-td" colspan="2">
                                    <label for="docid" class="form-label">Select shop: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
            ...
            $sqlmain= "select schedule.scheduleid,schedule.title,shop.docname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join shop on schedule.docid=shop.docid  where  schedule.scheduleid=$id";
            $result= $database->query($sqlmain);
            $row=$result->fetch_assoc();
            $docname=$row["docname"];
            $scheduleid=$row["scheduleid"];
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="Email" class="form-label">shop of this session: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
